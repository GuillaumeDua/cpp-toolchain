...
| [details/](details/) | This repository's own tooling - the version-pin guard, the release-note renderer, the promotion-record schema and the image smoke test. Not reusable: they parse this repo's `Dockerfile`, `renovate.json` and `releases/` records. See [details/README.md](details/README.md). |
